...
namespace EA {
void create_schema(proto::SchemaInfo& table)
{
    ...
    proto::FieldInfo* field;
    field = table.add_fields();
    field->set_field_name("account_id");
    field->set_mysql_type(proto::UINT32);
    ...
    field->set_mysql_type(proto::INT64);
    ...
    field->set_mysql_type(proto::STRING);
    ...
    proto::IndexInfo* pk_idx = table.add_indexs();
    pk_idx->set_index_name("PRIMARY");
    pk_idx->set_index_type(proto::I_PRIMARY);
    ...
    proto::IndexInfo* sec_idx = table.add_indexs();
    sec_idx->set_index_name("title_key");
    sec_idx->set_index_type(proto::I_FULLTEXT);
