...
int create_table(const std::string& namespace_name, const std::string& database, 
    ...
    std::map<std::string, std::vector<proto::RegionInfo>> index_region_infos;
    ...
    for (auto& region_infos_per_index : index_region_infos) {
        ...
        std::map<std::string, const proto::RegionInfo*> table_key_map;
...
int main(int argc, char **argv) {
    ...
    EA::create_table(EA::FLAGS_namespace_name,
                           EA::FLAGS_database,
                           EA::FLAGS_table_name);
