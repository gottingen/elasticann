...
namespace EA {
    ...
    public:
        ...
        proto::LockCmdType lock_type() { return _lock_type; }
        ...
        std::vector<proto::SlotDescriptor> &primary_slots() {
    ...
    protected:
        ...
        proto::TupleDescriptor *_values_tuple_desc = nullptr;
