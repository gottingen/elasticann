...
void PacketNode::pack_trace2(std::vector<std::map<std::string, std::string>>& info, const proto::TraceNode& trace_node,
...
int PacketNode::pack_ok(int num_affected_rows, NetworkSocket* client) {
    ...
    int64_t last_insert_id = (op_type() == proto::OP_INSERT || op_type() == proto::OP_UPDATE)? client->last_insert_id : 0;
