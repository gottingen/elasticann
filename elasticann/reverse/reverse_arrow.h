    ...
    public:
        ...
        ArrowReverseNode reverse_nodes(int index) const {
            if (index != _current_node_index) {
                ...
                node.set_flag(EA::proto::ReverseNodeType(_flags_ptr->Value(index)));
        ...
        proto::ReverseNodeType get_flag(int64_t index) const {
            return proto::ReverseNodeType(_flags_ptr->Value(index));
        }
        ...
        ArrowReverseNode *mutable_reverse_nodes(int64_t index) {
            if (_current_node_index != index) {
                ...
                _inner_node.set_flag(proto::ReverseNodeType(_flags_ptr->Value(index)));
