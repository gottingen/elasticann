...
int Tokenizer::simple_seg(
    std::string word, uint32_t word_count, std::map<std::string, float>& term_map, const proto::Charset& charset) {
...
std::vector<Tokenizer::SeperateIndex> Tokenizer::q2b_tolower_with_index(std::string& word, const proto::Charset& charset) {
    switch (charset) {
    case proto::GBK:
