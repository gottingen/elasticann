...
namespace EA {
    ...
    public:
        ...
        virtual int create_executor(const std::string &search_data,
                                    proto::MatchMode mode, proto::SegmentType segment_type,
                                    const proto::Charset &charset) = 0;
...
//多个倒排索引间做or操作，只读
    ...
    public:
        ...
        int
        init_operator_executor(const proto::FulltextIndex &fulltext_index_info, OperatorBooleanExecutor<Schema> *&exe);
