...
public:
    ...
    //"hello world"
    int create_executor(
        const std::string& search_data, proto::MatchMode mode, proto::SegmentType segment_type, const proto::Charset& charset);
...
using CommonSchema = NewSchema<proto::CommonReverseNode, proto::CommonReverseList>;
