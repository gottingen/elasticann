...
int LogicalPlanner::construct_in_predicate_node(const parser::FuncExpr* func_item, proto::Expr& expr, proto::ExprNode** node) {
...
int LogicalPlanner::create_agg_expr(const parser::FuncExpr* expr_item, proto::Expr& expr, const CreateExprOptions& options) {
...
int LogicalPlanner::create_between_expr(const parser::FuncExpr* item, proto::Expr& expr, const CreateExprOptions& options) {
...
int LogicalPlanner::create_scala_func_expr(const parser::FuncExpr* item, 
        proto::Expr& expr, parser::FuncType op, const CreateExprOptions& options) {
...
int LogicalPlanner::create_expr_tree(const parser::Node* item, proto::Expr& expr, const CreateExprOptions& options) {
    if (item == nullptr) {
...
int LogicalPlanner::create_row_expr_node(const parser::RowExpr* item, proto::Expr& expr, const CreateExprOptions& options) {
    proto::ExprNode* node = expr.add_nodes();
    node->set_col_type(proto::INVALID_TYPE);
