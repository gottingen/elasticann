...
int DDLPlanner::add_constraint_def(proto::SchemaInfo& table, parser::Constraint* constraint,parser::AlterTableSpec* spec) {
    proto::IndexInfo* index = table.add_indexs();
...
bool DDLPlanner::is_fulltext_type_constraint(proto::StorageType pb_storage_type, bool& has_arrow_fulltext, bool& has_pb_fulltext) const {
