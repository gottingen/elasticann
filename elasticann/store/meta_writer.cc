...
namespace EA {
    ...
    int MetaWriter::init_meta_info(const proto::RegionInfo &region_info) {
    ...
    int MetaWriter::update_region_info(const proto::RegionInfo &region_info) {
        int64_t region_id = region_info.region_id();
    ...
    int MetaWriter::update_region_ddl_info(const proto::StoreRegionDdlInfo &region_ddl_info) {
    ...
    int MetaWriter::parse_region_infos(std::vector<proto::RegionInfo> &region_infos) {
    ...
    int MetaWriter::read_region_info(int64_t region_id, proto::RegionInfo &region_info) {
        std::string value;
        rocksdb::ReadOptions options;
    ...
    int MetaWriter::read_region_ddl_info(int64_t region_id, proto::StoreRegionDdlInfo &region_ddl_info) {
        std::string value;
        rocksdb::ReadOptions options;
