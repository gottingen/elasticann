...
//handle abnormal regions remove_illegal_peer resource_tag learner
    bool HandleHelper::_handle_abnormal_regions(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        static std::map<std::string, proto::RecoverOpt> opt_map = {
                {"remove_illegal_peer", proto::DO_REMOVE_ILLEGAL_PEER},
                {"remove_error_peer",   proto::DO_REMOVE_PEER},
                {"set_peer",            proto::DO_SET_PEER},
                {"init_peer",           proto::DO_INIT_REGION}
        };
        ...
        if (is_remove_learner) {
            ...
            query_req.set_op_type(proto::QUERY_REGION_LEARNER_STATUS);
            ...
            proto::RecoverOpt recover_opt = iter->second;
            request.set_op_type(proto::OP_RECOVERY_ALL_REGION);
    ...
    bool HandleHelper::is_packet_learner_result_success(const SmartSocket &client,
                                                        const proto::QueryRequest &query_req,
                                                        proto::QueryResponse &query_res) {
    ...
    void HandleHelper::update_unhealthy_learners_schema(const proto::QueryRequest &query_req,
        ...
        for (auto &region_info: query_res.region_status_infos()) {
            ...
            for (auto &peer_info: region_info.peer_status_infos()) {
                if (peer_info.peer_status() != proto::STATUS_NORMAL) {
                    peer_id_peer_status[peer_info.peer_id()] = proto::PeerStatus_Name(peer_info.peer_status());
                }
            }
            proto::MetaManagerRequest request_update_region;
            proto::MetaManagerResponse response_update_region;
            request_update_region.set_op_type(proto::OP_UPDATE_REGION);
            auto region_iter = request_update_region.add_region_infos();
            int ret = -1;
            proto::RegionInfo update_region_info;
            ...
            *region_iter = update_region_info;
            ...
            if (response_update_region.errcode() == proto::SUCCESS) {
    ...
    void HandleHelper::_make_handle_region_result_rows(
            const proto::MetaManagerRequest &request,
            const proto::MetaManagerResponse &response,
            std::vector<std::vector<std::string>> &rows) {
        if (response.has_recover_response()) {
            ...
            for (auto &peer_info: recover_region_way) {
                ...
                row.emplace_back(proto::RecoverOpt_Name(request.recover_opt()));
    ...
    bool HandleHelper::_handle_add_privilege(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_ADD_PRIVILEGE);
    ...
    HandleHelper::_handle_table_resource_tag(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_MODIFY_RESOURCE_TAG);
    ...
    HandleHelper::_handle_load_balance_switch(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        static std::map<std::string, proto::OpType> opt_map = {
                {"load_balance_open",     proto::OP_OPEN_LOAD_BALANCE},
                {"load_balance_close",    proto::OP_CLOSE_LOAD_BALANCE},
                {"migrate_open",          proto::OP_OPEN_MIGRATE},
                {"migrate_close",         proto::OP_CLOSE_MIGRATE},
                {"network_balance_open",  proto::OP_OPEN_NETWORK_SEGMENT_BALANCE},
                {"network_balance_close", proto::OP_CLOSE_NETWORK_SEGMENT_BALANCE},
        };
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        std::string _switch = "";
    ...
    bool HandleHelper::_handle_create_namespace(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_CREATE_NAMESPACE);
    ...
    bool HandleHelper::_handle_table_main_logical_room(const SmartSocket &client,
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_MAIN_LOGICAL_ROOM);
        auto info = request.mutable_table_info();
    ...
    bool HandleHelper::_handle_split_lines(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_SPLIT_LINES);
        auto info = request.mutable_table_info();
    ...
    bool HandleHelper::_handle_ttl_duration(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_TTL_DURATION);
        auto info = request.mutable_table_info();
        info->set_table_name(split_vec[2]);
        info->set_database(client->current_db);
        info->set_namespace_name(client->user_info->namespace_);
    ...
    bool HandleHelper::_handle_rm_privilege(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_DROP_PRIVILEGE);
        ...
        info->set_namespace_name(client->user_info->namespace_);
        if (table == "") {
            proto::PrivilegeDatabase privilege_database;
            ...
            *db_info = privilege_database;
            ...
            proto::PrivilegeTable privilege_table;
    ...
    bool HandleHelper::_handle_modify_partition(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_MODIFY_PARTITION);
        auto info = request.mutable_table_info();
        info->set_table_name(table);
        info->set_database(db);
        info->set_namespace_name(client->user_info->namespace_);
    ...
    bool HandleHelper::_handle_ddlwork(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        static std::map<std::string, proto::OpType> opt_map = {
                {"delete_ddl",  proto::OP_DELETE_DDLWORK},
                {"suspend_ddl", proto::OP_SUSPEND_DDL_WORK},
                {"restart_ddl", proto::OP_RESTART_DDL_WORK},
        };
        SchemaFactory *factory = SchemaFactory::get_instance();
    ...
    bool HandleHelper::_handle_update_dists(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_DISTS);
        auto info = request.mutable_table_info();
        *info = table_info;
    ...
    bool HandleHelper::_send_store_raft_control_request(const SmartSocket &client, proto::RaftControlRequest &req,
                                                        proto::RegionInfo &info) {
        int retry_time = 3;
        std::string leader = info.leader();
        while (retry_time-- > 0) {
    ...
    bool HandleHelper::_handle_store_rm_peer(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::RaftControlRequest req;
        req.set_op_type(proto::SetPeer);
        req.set_region_id(region_id);
        proto::RegionInfo info;
        if (factory->get_region_info(table_id, region_id, info) != 0) {
            TLOG_WARN("param invalid, no region {} in table {}", region_id, table_id);
    ...
    bool
    HandleHelper::_handle_store_trans_leader(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::RaftControlRequest req;
        req.set_op_type(proto::TransLeader);
        req.set_region_id(region_id);
        proto::RegionInfo info;
        if (factory->get_region_info(table_id, region_id, info) != 0) {
            TLOG_WARN("param invalid, no region {} in table {}", region_id, table_id);
    ...
    bool HandleHelper::_handle_add_user(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_CREATE_USER);
        auto info = request.mutable_user_privilege();
        *info = user_info;
    ...
    bool HandleHelper::_handle_instance_param(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_INSTANCE_PARAM);
    ...
    bool HandleHelper::_handle_schema_conf(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_UPDATE_SCHEMA_CONF);
        auto table_info = request.mutable_table_info();
        table_info->set_table_name(table_name);
    ...
    bool HandleHelper::_handle_migrate_instance(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_SET_INSTANCE_MIGRATE);
    ...
    bool HandleHelper::_handle_instance_status(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::MetaManagerRequest request;
        proto::MetaManagerResponse response;
        request.set_op_type(proto::OP_SET_INSTANCE_STATUS);
        auto instance_info = request.mutable_instance();
        instance_info->set_address(instance_address);
    ...
    bool
    HandleHelper::_handle_store_compact_region(const SmartSocket &client, const std::vector<std::string> &split_vec) {
    ...
    bool HandleHelper::_handle_region_adjustkey(const SmartSocket &client, const std::vector<std::string> &split_vec) {
        ...
        proto::StoreRes res;
        proto::StoreReq req;
        req.set_op_type(proto::OP_ADJUSTKEY_AND_ADD_VERSION);
