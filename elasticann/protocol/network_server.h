...
namespace EA {
    ...
    private:
        ...
        void construct_other_heart_beat_request(proto::BaikalOtherHeartBeatRequest &request);

        void process_other_heart_beat_response(const proto::BaikalOtherHeartBeatResponse &response);
