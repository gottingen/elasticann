...
int MysqlWrapper::decode_binary_protocol_value(
    ...
    case MYSQL_TYPE_VAR_STRING: {
        ...
        proto::DeriveExprNode* str_node = node.mutable_derive_node();
    ...
    case MYSQL_TYPE_TINY: {
        ...
        if (type.is_unsigned) {
            node.set_col_type(proto::UINT8);
        } else {
            node.set_col_type(proto::INT8);
        }
        node.set_num_children(0);
        proto::DeriveExprNode* str_node = node.mutable_derive_node();
    ...
    case MYSQL_TYPE_SHORT: {
        ...
        node.set_node_type(proto::INT_LITERAL);
        if (type.is_unsigned) {
            node.set_col_type(proto::UINT16);
        } else {
            node.set_col_type(proto::INT16);
        }
        node.set_num_children(0);
        proto::DeriveExprNode* str_node = node.mutable_derive_node();
        str_node->set_int_val(result);
    ...
    case MYSQL_TYPE_LONGLONG: {
        ...
        node.set_node_type(proto::INT_LITERAL);
        if (type.is_unsigned) {
            node.set_col_type(proto::UINT64);
        } else {
    ...
    case MYSQL_TYPE_FLOAT: {
        ...
        node.set_col_type(proto::FLOAT);
        node.set_num_children(0);
        proto::DeriveExprNode* float_node = node.mutable_derive_node();
    ...
    case MYSQL_TYPE_DOUBLE: {
        ...
        node.set_num_children(0);
        proto::DeriveExprNode* double_node = node.mutable_derive_node();
    ...
    case MYSQL_TYPE_TIMESTAMP: {
        ...
        if (type.mysql_type == MYSQL_TYPE_DATE) {
            node.set_node_type(proto::DATETIME_LITERAL);
