...
#include "elasticann/sqlparser/base.h"
...
namespace fmt {
    template<>
    struct formatter<::parser::ConstraintType> : public formatter<int> {
        auto format(const ::parser::ConstraintType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };

    template<>
    struct formatter<::parser::ColumnOptionType> : public formatter<int> {
        auto format(const ::parser::ColumnOptionType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };
    template<>
    struct formatter<::parser::MysqlType> : public formatter<int> {
        auto format(const ::parser::MysqlType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };
}
