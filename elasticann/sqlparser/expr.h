...
namespace fmt {
    template<>
    struct formatter<::parser::ExprType> : public formatter<int> {
        auto format(const ::parser::ExprType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };
    template<>
    struct formatter<::parser::LiteralType> : public formatter<int> {
        auto format(const ::parser::LiteralType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };

    template<>
    struct formatter<::parser::FuncType> : public formatter<int> {
        auto format(const ::parser::FuncType &a, format_context &ctx) const {
            return formatter<int>::format(static_cast<int>(a), ctx);
        }
    };
}