...
void TableManager::update_table_internal(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done,
        std::function<void(const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done)> update_callback) {
    int64_t table_id;
...
void TableManager::create_table(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
...
void TableManager::drop_table(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
...
void TableManager::drop_table_tombstone(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    std::vector<std::string> delete_rocksdb_keys;
...
void TableManager::restore_table(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    int64_t table_id = 0;
    if (check_table_exist(request.table_info(), table_id) == 0) {
...
void TableManager::put_incremental_schemainfo(const int64_t apply_index, std::vector<proto::SchemaInfo>& schema_infos) {
...
void TableManager::update_byte_size(const proto::MetaManagerRequest& request,
    ...
    update_table_internal(request, apply_index, done, 
        [](const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done) {
        ...
        if (schema_conf.storage_compute_separate()) {
            for (auto& index : mem_schema_pb.indexs()) {
                ...
                if (index.index_type() == proto::I_FULLTEXT) {
                    ...
                    IF_DONE_SET_RESPONSE(done, proto::INPUT_PARAM_ERROR, "fulltext not support kv mode");
                    return;
                }
            }
        }
    ...
    update_table_internal(request, apply_index, done, 
        [](const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done) {
            if (mem_schema_pb.ttl_duration() > 0 && request.table_info().ttl_duration() > 0) {
                ...
                if (mem_schema_pb.engine() == proto::REDIS || mem_schema_pb.engine() == proto::BINLOG) {
                    can_support_ttl = false;
                }
...
void TableManager::drop_index(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    //检查参数有效性
    ...
    auto index_to_del = std::find_if(std::begin(schema_info.indexs()), std::end(schema_info.indexs()), 
        [&index_req](const proto::IndexInfo& info) {
            ...
            return boost::algorithm::iequals(info.index_name(), index_req.index_name()) &&
                (info.index_type() == proto::I_UNIQ || info.index_type() == proto::I_KEY ||
...
int TableManager::init_global_index_region(TableMem& table_mem, braft::Closure* done, proto::IndexInfo& index_info) {
    std::vector<std::string> rocksdb_keys;
    std::vector<std::string> rocksdb_values;
        ...
        [](const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done) {
            ...
            for (; index_iter != mem_schema_pb.mutable_indexs()->end(); index_iter++) {
                if (request_index_info.index_id() == index_iter->index_id()) {
                    if (request_index_info.job_state() != proto::IS_DELETE_LOCAL && request_index_info.deleted()) {
                        //删除索引
                        ...
                        if (request_index_info.op_type() == proto::OP_DROP_INDEX && index_iter->hint_status() == proto::IHS_NORMAL) {
...
void TableManager::link_binlog(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
...
void TableManager::unlink_binlog(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    DB_DEBUG("link binlog, request:%s", request.ShortDebugString().c_str());
    int64_t table_id;
    if (check_table_exist(request.table_info(), table_id) != 0) {
        DB_WARNING("check table exist fail, request:%s", request.ShortDebugString().c_str());
...
void TableManager::set_index_hint_status(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    update_table_internal(request, apply_index, done, 
        [](const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done) {
                ...
                for (const auto& index_info : request.table_info().indexs()) {
                    ...
                    for (; index_iter != mem_schema_pb.mutable_indexs()->end(); index_iter++) {
                        ...
                        if (boost::algorithm::iequals(index_iter->index_name(), index_info.index_name()) &&
                            ...
                            if (index_info.hint_status() == proto::IHS_NORMAL && index_iter->state() != proto::IS_PUBLIC) {
                                continue;
                            }
...
void TableManager::drop_virtual_index(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
       update_table_internal(request, apply_index, done, 
        [](const proto::MetaManagerRequest& request, proto::SchemaInfo& mem_schema_pb, braft::Closure* done) {
            if (request.has_table_info()) {
...
void TableManager::add_learner(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    int ret = 0;
...
void TableManager::drop_learner(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    int ret = 0;
    DB_DEBUG("request:%s", request.ShortDebugString().c_str());
    int64_t table_id;
    if (check_table_exist(request.table_info(), table_id) != 0 && 
...
void TableManager::remove_global_index_data(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done) {
    int ret = 0;
