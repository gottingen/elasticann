...
namespace EA {
    ...
    struct RegionPeerState {
        std::vector<proto::PeerStateInfo> legal_peers_state;  // peer in raft-group
        std::vector<proto::PeerStateInfo> ilegal_peers_state; // peer not in raft-group
    };

    struct RegionLearnerState {
        std::map<std::string, proto::PeerStateInfo> learner_state_map;
        TimeCost tc;
    };
    ...
    public:
        void update_region(const proto::MetaManagerRequest &request, const int64_t apply_index, braft::Closure *done);

        void restore_region(const proto::MetaManagerRequest &request, proto::MetaManagerResponse *response);

        void drop_region(const proto::MetaManagerRequest &request, const int64_t apply_index, braft::Closure *done);

        void split_region(const proto::MetaManagerRequest &request, braft::Closure *done);
        ...
        void check_update_region(const proto::BaikalHeartBeatRequest *request,
        ...
        void update_leader_status(const proto::StoreHeartBeatRequest *request, int64_t timestamp);

        void leader_heartbeat_for_region(const proto::StoreHeartBeatRequest *request,
                                         proto::StoreHeartBeatResponse *response);

        void check_whether_illegal_peer(const proto::StoreHeartBeatRequest *request,
                                        proto::StoreHeartBeatResponse *response);
        ...
        void recovery_all_region(const proto::MetaManagerRequest &request, proto::MetaManagerResponse *response);
    ...
    private:
        ...
        void leader_main_logical_room_check(const proto::StoreHeartBeatRequest *request,
                                            proto::StoreHeartBeatResponse *response,
                                            IdcInfo &leader_idc,
        ...
        int get_region_status(int64_t region_id, proto::Status &status);
        ...
        void set_region_info(const proto::RegionInfo &region_info);
        ...
        void put_incremental_regioninfo(const int64_t apply_index, std::vector<proto::RegionInfo> &region_infos);
        ...
        void add_learner_peer(int64_t region_id,
                              std::vector<std::pair<std::string, proto::InitRegion>> &modify_learner_requests,
        ...
        void remove_learner_peer(int64_t region_id,
                                 std::vector<std::pair<std::string, proto::RemoveRegion>> &modify_learner_requests,
                                 proto::RegionInfo *master_region_info,
    ...
    private:
        ...
        IncrementalUpdate<std::vector<proto::RegionInfo>> _incremental_region_info;
    }; //class
    ...
    inline void RegionManager::clear_region_peer_state_map() {
        _region_peer_state_map.clear();
    }

    inline void RegionManager::clear_region_learner_peer_state_map() {
        _region_learner_peer_state_map.clear();
    }

    inline void RegionManager::set_max_region_id(int64_t max_region_id) {
        _max_region_id = max_region_id;
    }

    [[nodiscard]] inline int64_t RegionManager::get_max_region_id() const {
        return _max_region_id;
    }

    inline void RegionManager::get_all_region_peers(int64_t region_id, std::vector<std::string> &peers) {
    ...
    inline void RegionManager::get_region_ids(const std::string &instance, std::vector<int64_t> &region_ids) {
    ...
    inline void RegionManager::get_learner_ids(const std::string &instance, std::vector<int64_t> &region_ids) {
    ...
    inline void RegionManager::get_region_ids(const std::string &instance,
                                              std::unordered_map<int64_t, std::set<int64_t>> &table_region_ids) {
        BAIDU_SCOPED_LOCK(_instance_region_mutex);
        if (_instance_region_map.find(instance) == _instance_region_map.end()) {
            return;
    ...
    inline void RegionManager::print_region_ids(const std::string &instance) {
        BAIDU_SCOPED_LOCK(_instance_region_mutex);
        if (_instance_region_map.find(instance) == _instance_region_map.end()) {
            return;
        }
    ...
    inline int RegionManager::get_region_status(int64_t region_id, proto::Status &status) {
    ...
    inline void RegionManager::whether_add_instance(const std::map<std::string, int64_t> &uniq_instance) {
    ...
    inline void RegionManager::set_region_info(const proto::RegionInfo &region_info) {
        ...
        auto ptr_region = std::make_shared<proto::RegionInfo>(region_info);
        _region_info_map.set(region_id, ptr_region);
    }

    inline void RegionManager::set_region_state(int64_t region_id, const RegionStateInfo &region_state) {
        _region_state_map.set(region_id, region_state);
    }

    inline void RegionManager::erase_region_state(const std::vector<std::int64_t> &drop_region_ids) {
    ...
    inline void RegionManager::set_region_mem_info(int64_t region_id,
    ...
    inline void RegionManager::set_region_leader(int64_t region_id,
                                                 const std::string &new_leader) {
        SmartRegionInfo region_ptr = _region_info_map.get(region_id);
        if (region_ptr != nullptr) {
            auto new_region_ptr = std::make_shared<proto::RegionInfo>(*region_ptr);
            new_region_ptr->set_leader(new_leader);
            _region_info_map.set(region_id, new_region_ptr);
        }
    }

    inline void RegionManager::set_instance_leader_count(const std::string &instance,
                                                         const std::unordered_map<int64_t, int64_t> &table_leader_count,
                                                         const std::unordered_map<std::string, int64_t> &pk_prefix_leader_count) {
    ...
    inline int64_t
    RegionManager::get_pk_prefix_leader_count(const std::string &instance, const std::string &pk_prefix_key) {
        BAIDU_SCOPED_LOCK(_count_mutex);
    ...
    inline void RegionManager::add_remove_peer_on_pk_prefix(const int64_t &region_id, const IdcInfo &idc) {
        BAIDU_SCOPED_LOCK(_count_mutex);
        _remove_region_peer_on_pk_prefix[region_id] = idc;
    }

    inline bool RegionManager::need_remove_peer_on_pk_prefix(const int64_t &region_id, IdcInfo &idc) {
        BAIDU_SCOPED_LOCK(_count_mutex);
    ...
    inline void RegionManager::clear_remove_peer_on_pk_prefix(const int64_t region_id) {
        BAIDU_SCOPED_LOCK(_count_mutex);
        _remove_region_peer_on_pk_prefix.erase(region_id);
    }

    inline int64_t RegionManager::get_leader_count(const std::string &instance, int64_t table_id) {
        BAIDU_SCOPED_LOCK(_count_mutex);
    ...
    inline int64_t RegionManager::get_leader_count(const std::string &instance) {
        BAIDU_SCOPED_LOCK(_count_mutex);
        if (_instance_leader_count.find(instance) == _instance_leader_count.end()) {
            return 0;
        }
    ...
    inline void RegionManager::add_leader_count(const std::string &instance, int64_t table_id) {
        BAIDU_SCOPED_LOCK(_count_mutex);
    ...
    inline void RegionManager::traverse_region_map(const std::function<void(SmartRegionInfo &region)> &call) {
        _region_info_map.traverse(call);
    }

    inline void RegionManager::traverse_copy_region_map(const std::function<void(SmartRegionInfo &region)> &call) {
        _region_info_map.traverse_copy(call);
    }

    inline ThreadSafeMap<int64_t, RegionPeerState> &RegionManager::region_peer_state_map() {
        return _region_peer_state_map;
    }

    inline bool RegionManager::can_modify_learner(int64_t region_id) {
    ...
    inline bool RegionManager::get_learner_health_status(const std::string &learner, int64_t region_id) {
        bool status = true;
        _region_learner_peer_state_map.update(region_id, [&status, &learner](RegionLearnerState &rls) {
            ...
            if (learn_iter != rls.learner_state_map.end()) {
                status = (learn_iter->second.peer_status() == proto::STATUS_NORMAL);
            }
        });
        return status;
    }
