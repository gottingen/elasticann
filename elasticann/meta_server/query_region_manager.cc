...
void QueryRegionManager::get_region_peer_status(const proto::QueryRequest* request, proto::QueryResponse* response) {
    RegionManager* manager = RegionManager::get_instance();
...
void QueryRegionManager::get_region_learner_status(const proto::QueryRequest* request, proto::QueryResponse* response) {
    RegionManager* manager = RegionManager::get_instance();
    std::map<int64_t, std::string> table_id_name_map;
