...
namespace EA {
    void QueryClusterManager::get_logical_info(const proto::QueryRequest *request,
    ...
    void QueryClusterManager::get_physical_info(const proto::QueryRequest *request,
                                                proto::QueryResponse *response) {
        ClusterManager *manager = ClusterManager::get_instance();
        {
            BAIDU_SCOPED_LOCK(manager->_physical_mutex);
    ...
    void QueryClusterManager::get_instance_info(const proto::QueryRequest *request,
                                                proto::QueryResponse *response) {
        ClusterManager *manager = ClusterManager::get_instance();
        {
            BAIDU_SCOPED_LOCK(manager->_instance_mutex);
    ...
    void QueryClusterManager::get_instance_param(const proto::QueryRequest *request,
                                                 proto::QueryResponse *response) {
        ClusterManager *manager = ClusterManager::get_instance();
        {
    ...
    void QueryClusterManager::get_flatten_instance(const proto::QueryRequest *request,
                                                   proto::QueryResponse *response) {
        ClusterManager *manager = ClusterManager::get_instance();
        std::string logical_room = request->logical_room();
        turbo::Trim(&logical_room);
        std::string physical_room = request->physical_room();
        turbo::Trim(&physical_room);
        std::string instance_address = request->instance_address();
        turbo::Trim(&instance_address);
    ...
    void QueryClusterManager::process_console_heartbeat(const proto::ConsoleHeartBeatRequest *request,
    ...
    void QueryClusterManager::get_region_ids(const proto::QueryRequest *request,
                                             proto::QueryResponse *response) {
        if (!request->has_instance_address()) {
            response->set_errcode(proto::INPUT_PARAM_ERROR);
            response->set_errmsg("input has no instance_address");
    ...
    void QueryClusterManager::get_network_segment(const proto::QueryRequest *request,
                                                  proto::QueryResponse *response) {
    ...
    void QueryClusterManager::mem_instance_to_pb(const Instance &instance_mem, proto::InstanceInfo *instance_pb) {
    ...
    void QueryClusterManager::construct_query_response_for_instance(const Instance &instance_info,
                                                                    std::map<std::string, std::multimap<std::string, proto::QueryInstance>> &logical_instance_infos) {
        ClusterManager *manager = ClusterManager::get_instance();
        proto::QueryInstance query_info;
        ...
        std::multimap<std::string, proto::QueryInstance> physical_instance_infos;
        ...
        physical_instance_infos.insert(std::pair<std::string, proto::QueryInstance>(physical_room, query_info));
