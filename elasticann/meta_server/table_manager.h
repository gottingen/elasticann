...
public:
    ...
    void update_table_internal(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done,
    ...
    void drop_table_tombstone(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    ...
    void update_byte_size(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_split_lines(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_charset(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void modify_partition(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void set_main_logical_room(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_schema_conf(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_statistics(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_dists(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_ttl_duration(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_resource_tag(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    void update_table_comment(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    ...
    void set_index_hint_status(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
    ...
    void update_index_status(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
...
public:
    ...
    void remove_global_index_data(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);

    void drop_index_request(const proto::DdlWorkInfo& ddl_work);

    void get_delay_delete_index(std::vector<proto::SchemaInfo>& index_to_delete, std::vector<proto::SchemaInfo>& index_to_clear) {
...
private:
    ...
    void drop_virtual_index(const proto::MetaManagerRequest& request, const int64_t apply_index, braft::Closure* done);
