...
// @ref: https://rapidjson.org/md_doc_pointer.html#JsonPointer
    ...
    ExprValue unix_timestamp(const std::vector<ExprValue> &input) {
        ...
        if (input.size() == 0) {
            ...
            if (in.type == proto::INT64) {
                in.cast_to(proto::STRING);
            }
            tmp._u.uint32_val = in.cast_to(proto::TIMESTAMP)._u.uint32_val;
        }
        return tmp;
    }
    ...
    ExprValue timestamp(const std::vector<ExprValue> &input) {
        ...
        ExprValue ret = arg1.cast_to(proto::DATETIME).cast_to(proto::TIMESTAMP);
        if (input.size() == 2) {
    ...
    ExprValue str_to_date(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        return tmp.cast_to(proto::DATETIME);
    }
    ...
    ExprValue time_format(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        struct tm t_result;
        uint32_t second = tmp.cast_to(proto::TIME)._u.int32_val;
    ...
    ExprValue convert_tz(const std::vector<ExprValue> &input) {
        ...
        ExprValue ret = time.cast_to(proto::TIMESTAMP);
        ret._u.uint32_val += second_diff;
        return ret.cast_to(proto::DATETIME);
    }
    ...
    ExprValue timediff(const std::vector<ExprValue> &input) {
        ...
        int32_t seconds = arg1.cast_to(proto::TIMESTAMP)._u.uint32_val -
                          arg2.cast_to(proto::TIMESTAMP)._u.uint32_val;
        ExprValue ret(proto::TIME);
    ...
    ExprValue timestampdiff(const std::vector<ExprValue> &input) {
        ...
        int32_t seconds = arg3.cast_to(proto::TIMESTAMP)._u.uint32_val -
                          arg2.cast_to(proto::TIMESTAMP)._u.uint32_val;
        ExprValue ret(proto::INT64);
    ...
    ExprValue curdate(const std::vector<ExprValue> &input) {
        ExprValue tmp(proto::DATE);
        uint64_t datetime = timestamp_to_datetime(time(nullptr));
    ...
    ExprValue day(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp(proto::UINT32);
        uint64_t dt = in.cast_to(proto::DATETIME)._u.uint64_val;
    ...
    ExprValue time_to_sec(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp(proto::INT32);
        ExprValue in = input[0];
        time_t time = in.cast_to(proto::TIME)._u.int32_val;
        bool minus = false;
        if (time < 0) {
            minus = true;
            time = -time;
    ...
    ExprValue sec_to_time(const std::vector<ExprValue> &input) {
        ...
        ExprValue in = input[0];
        if (in.type == proto::STRING) {
            in.cast_to(proto::INT32);
        }
    ...
    ExprValue weekday(const std::vector<ExprValue> &input) {
        ...
        try {
            turbo::CivilDay today(year, month, day);
            ExprValue tmp(proto::UINT32);
            uint32_t day_of_week = static_cast<uint32_t>(turbo::GetWeekday(today));
            if (day_of_week >= 1) {
    ...
    int calc_week(const std::vector<ExprValue> &input, bool is_yearweek, int &year, int &weeks) {
        ...
        uint64_t dt = one.cast_to(proto::DATETIME)._u.uint64_val;
        ...
        turbo::CivilDay today;
        turbo::CivilDay first_day;
        try {
        ...
        // 第一天是星期几
        int first_weekday = static_cast<int>(turbo::GetWeekday(first_day));
    ...
    ExprValue weekofyear(const std::vector<ExprValue> &input) {
        ...
        try {
            turbo::CivilDay today(year, month, day);
            ///TODO
            uint32_t week_number = 1;//turbo::GetWeekday();
            ExprValue tmp(proto::UINT32);
    ...
    ExprValue datediff(const std::vector<ExprValue> &input) {
        ...
        if (left.type == proto::INT64) {
            left.cast_to(proto::STRING);
        }
        ExprValue right = input[1];
        if (right.type == proto::INT64) {
            right.cast_to(proto::STRING);
        }
        time_t t1 = left.cast_to(proto::TIMESTAMP)._u.uint32_val;
        time_t t2 = right.cast_to(proto::TIMESTAMP)._u.uint32_val;
        ExprValue tmp(proto::INT32);
    ...
    ExprValue date_add(const std::vector<ExprValue> &input) {
        ...
        ExprValue arg1 = input[0];
        ExprValue arg2 = input[1];
        int32_t interval = arg2.cast_to(proto::INT32)._u.int32_val;
        ExprValue ret;
        if (!arg1.is_numberic()) {
            ret = arg1.cast_to(proto::TIMESTAMP);
        } else {
            ret = arg1.cast_to(proto::STRING).cast_to(proto::TIMESTAMP);
        }
    ...
    ExprValue extract(const std::vector<ExprValue> &input) {
        ...
        ExprValue arg2 = input[1];
        ExprValue tmp(proto::UINT32);
        time_t t = arg2.cast_to(proto::TIMESTAMP)._u.uint32_val;
        struct tm tm;
        localtime_r(&t, &tm);
    ...
    ExprValue timestamp_to_tso(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp(proto::INT64);
        arg_timestamp.cast_to(proto::TIMESTAMP);
    ...
    ExprValue md5(const std::vector<ExprValue> &input) {
        ...
        if (orig.type != proto::STRING) {
            orig.cast_to(proto::STRING);
        }
        ExprValue tmp(proto::STRING);
...
*/
    ...
    ExprValue tdigest_build(const std::vector<ExprValue> &input) {
        ...
        ExprValue result(proto::TDIGEST);
    ...
    ExprValue last_insert_id(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        return tmp.cast_to(proto::INT64);
    }
    ...
    ExprValue cast_to_string(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        return tmp.cast_to(proto::STRING);
    }
    ...
    ExprValue cast_to_unsigned(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        return tmp.cast_to(proto::UINT64);
    }
    ...
    ExprValue cast_to_double(const std::vector<ExprValue> &input) {
        ...
        ExprValue tmp = input[0];
        return tmp.cast_to(proto::DOUBLE);
    }
