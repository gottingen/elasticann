...
#ifndef ELASTICANN_OPS_DICT_DICT_MANAGER_H_
#define ELASTICANN_OPS_DICT_DICT_MANAGER_H_
...
namespace EA {
    ...
    private:
        ...
        friend class QueryFileManager;

        int load_dict_snapshot(const std::string &value);
...
#endif  // ELASTICANN_OPS_DICT_DICT_MANAGER_H_
