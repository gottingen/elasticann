...
#ifndef ELASTICANN_OPS_DICT_DICT_STATE_MACHINE_H_
#define ELASTICANN_OPS_DICT_DICT_STATE_MACHINE_H_
...
#define FILE_SERVICE_SET_DONE_AND_RESPONSE(done, errcode, err_message) \
    do {\
...
#endif  // ELASTICANN_OPS_DICT_DICT_STATE_MACHINE_H_
