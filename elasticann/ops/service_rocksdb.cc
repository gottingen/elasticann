...
namespace EA {
    ...
    int ServiceRocksdb::put_meta_info(const std::string &key, const std::string &value) {
    ...
    int ServiceRocksdb::put_meta_info(const std::vector<std::string> &keys,
    ...
    int ServiceRocksdb::get_meta_info(const std::string &key, std::string *value) {
    ...
    int ServiceRocksdb::delete_meta_info(const std::vector<std::string> &keys) {
        rocksdb::WriteOptions write_option;
        write_option.disableWAL = true;
        rocksdb::WriteBatch batch;
        for (auto &key: keys) {
    ...
    int ServiceRocksdb::write_meta_info(const std::vector<std::string> &put_keys,
