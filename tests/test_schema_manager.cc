...
DOCTEST_TEST_CASE_FIXTURE(SchemaManagerTest, "test_create_drop_modify") {
    //测试点：添加region
    EA::servlet::MetaManagerRequest request_update_region_fc;
    request_update_region_fc.set_op_type(EA::servlet::OP_UPDATE_REGION);
    ...
    request_update_region_fc.mutable_region_info()->set_status(EA::servlet::IDLE);
    ...
    EA::servlet::MetaManagerRequest request_split_region_fc;
    ...
    //为后续测试准备数据
    //feed库新建userinfo表
    EA::servlet::MetaManagerRequest request_create_table_feed;
    request_create_table_feed.set_op_type(EA::servlet::OP_CREATE_TABLE);
    ...
    request_update_region_feed.mutable_region_info()->set_status(EA::servlet::IDLE);
    ...
    EA::servlet::MetaManagerRequest request_split_region_feed;
